...
export default function StatusPage() {
  ...
  useEffect(() => { robotActions.connectRobot(); const timer = setInterval(() => robotActions.refreshStatusBundle(), refreshIntervalMs); return () => clearInterval(timer); }, [refreshIntervalMs]);
